    ...
    for opendapUrl in opendapUrls:
        ...
        while True:
            try:
                ...
                if 'scale_factor' in nc.variables[var_name].ncattrs():
                    scale_factor = getattr(nc.variables[var_name], 'scale_factor')
                else:
                    scale_factor = 1
                # print("scale_factor", scale_factor)

                if 'add_offset' in nc.variables[var_name].ncattrs():
...
def lambda_handler(event, context):
    ...
    for record in event['Records']:
        ...
        if "dataset_version" in input_json:
            dataset_version = input_json['dataset_version']
        else:
            dataset_version = ''
        ...
        #https://gpm1.gesdisc.eosdis.nasa.gov/opendap/GPM_L3/GPM_3IMERGDL.06/2022/contents.html
