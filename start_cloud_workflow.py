...
#    "end_date": "1998-09-21T17:38:27Z", "data_element_id": "fsdfrw345dsd"
    ...
    if dataset.lower() == 'precipitation':
        ...
        return dict(statusCode='400', headers={'Content-Type': 'application/json', 'Access-Control-Allow-Origin': '*'},
    ...
    s3.Bucket(data_bucket).upload_file("/tmp/" + request_id+"_geometry.json", geometry_pathname +request_id+"_geometry.json")
